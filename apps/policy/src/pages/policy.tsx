  ...
  return (
    <>
      ...
      <ul>
        ...
        <p>
          회원제 서비스 제공에 따른 본인 식별·인증, 회원자격 유지·관리 목적으로
          개인정보를 처리합니다.
        </p>
        <br />
        <p>2. 민원사무 처리</p>
      ...
      <ul>
        ...
        <li>보유근거 : 1학년부터 3학년까지의 JOBIS 서비스 이용을 위해</li>
        <li>관련법령 : </li>
        <li>예외사유 : </li>
      </ul>
      <br />
      ...
      <br />
      {"① < Team return >은(는) 다음의 개인정보 항목을 처리하고 있습니다."}
      <ul>
        <li>{"1< 홈페이지 회원가입 및 관리 >"}</li>
        <li>필수항목 : 이름, 성별, 비밀번호, 이메일, 부서, 직책</li>
        <li>선택항목 :</li>
      </ul>
      <br />
      <br />
      ...
      <br />
      {
        "① < Team return >은(는) 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 「개인정보 보호법」 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다."
      }
      <br />
      <br />
      {
        "② < Team return >은(는) 다음과 같이 개인정보를 제3자에게 제공하고 있습니다."
      }
      <br />
      <ul>
        <li>{"1. < JOBIS 서비스를 이용하는 기업 >"}</li>
        <li>개인정보를 제공받는 자 : JOBIS 서비스를 이용하는 기업</li>
        <li>제공받는 자의 개인정보 이용목적 : 이름</li>
      ...
      <>
        ...
        <br />
        {
          "① < Team return > 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다."
        }
        <br />
        <br />
        ...
        <br />
        {
          "< Team return > 은(는) 파기 사유가 발생한 개인정보를 선정하고, < Team return > 의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다."
        }
        <br />
        <br />
        ...
        <br /> <br /> <br />
        <p>
          ① 정보주체는 Team return에 대해 언제든지 개인정보
          열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
        </p>
        <p>
          ② 제1항에 따른 권리 행사는Team return에 대해 「개인정보 보호법」
          시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여
          하실 수 있으며 Team return은(는) 이에 대해 지체 없이 조치하겠습니다.
        </p>
        <p>
        ...
        <p>
          ⑥ Team return은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의
        ...
        <strong>
          ...
          <p>
            {
              "< Team return >은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다."
            }
          </p>
        </strong>
        <p>
        ...
        <p>
          2. 개인정보에 대한 접근 제한 개인정보를 처리하는 데이터베이스시스템에
        ...
        <p style={{ whiteSpace: "pre-wrap" }}>
          {
            "① Team return 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는‘쿠키(cookie)’를 사용합니다.\n② 쿠키는 웹사이트를 운영하는데 이용되는 서버(http)가 이용자의 컴퓨터 브라우저에게 보내는 소량의 정보이며이용자들의 PC 컴퓨터내의 하드디스크에 저장되기도 합니다.\n가. 쿠키의 사용 목적 : 이용자가 방문한 각 서비스와 웹 사이트들에 대한 방문 및 이용형태, 인기 검색어, 보안접속 여부, 등을 파악하여 이용자에게 최적화된 정보 제공을 위해 사용됩니다.\n나. 쿠키의 설치•운영 및 거부 : 웹브라우저 상단의 도구>인터넷 옵션>개인정보 메뉴의 옵션 설정을 통해 쿠키 저장을 거부 할 수 있습니다.\n다. 쿠키 저장을 거부할 경우 맞춤형 서비스 이용에 어려움이 발생할 수 있습니다."
          }
        </p>
        <strong>제9조 (개인정보 보호책임자에 관한사항)</strong>
        <p>
          ① Team return 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고,
        ...
        <ul>
          ...
          <li>직책 :백엔드</li>
          <li>직급 :팀리더</li>
          <li>연락처 :01062828267, kesksjxhx@gmail.com,</li>
        </ul>
        ※ 개인정보 보호 담당부서로 연결됩니다.
        <ul>
          <li>
        ...
        ② 정보주체께서는 Team return 의 서비스(또는 사업)을 이용하시면서 발생한
        모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
        개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. Team return
        ...
        <strong>
          ...
          아래의 부서에 할 수 있습니다. <br />
          {
            "< Team return >은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다."
          }
        </strong>
        <br />
        <br />
