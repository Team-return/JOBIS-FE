            ...
            (l = [
              {
                ...
                value: function (e2) {
                  let t3,
                    ...
                    s2 = {},
                    c = e2 || this.userAgent || "",
                    d = c.toLowerCase().replaceAll(/\s\s+/g, " "),
                    u =
                      /(edge)\/([\w.]+)/.exec(d) ||
                      /(edg)[/]([\w.]+)/.exec(d) ||
                      /(opr)[/]([\w.]+)/.exec(d) ||
                  ...
                  p === "chrome" &&
                    ...
                    p && (s2[p] = !0),
                    w && (s2[w] = !0);
                  let v = !!(s2.tablet || s2.android || s2.androidTablet),
                  ...
                  return {
                    ...
                    userAgent: c,
                    version: x,
                    shortVersion: x ? n(Number.parseFloat(x), 2) : null,
                    isAndroid: v,
                    isTablet: m,
                    isMobile: g,
                    isDesktop: h,
...
let REACT = __toESM(require_react()),
...
let errorMessages = new Set([
  ...
  shouldSkipError = error => errorMessages.has(error?.message);
...
let { FEATURES, CONFIG_TYPE } = scope,
...
for (const key of globalPackages) {
